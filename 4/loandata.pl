...
/* Experiments:
   1. vs (inductive bias):  Exchange 4 and 5.
   2. id3 (effect of noise): switch classes of 12 and 6.
*/
...
/*-----------------------------------------------------------*/
/* representing nominal attributes as structural (for vs.pl) */
son(yes,?).
son(no,?).
son(comp,?).
son(car,?).
...
/* The data below are not needed for VS */
